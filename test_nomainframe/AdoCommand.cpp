...
{
	ASSERT(pConnect != NULL && pConnect->GetConnection() != NULL );
	if( (pConnect==NULL) || pConnect->GetConnection() == NULL ) return FALSE;
	ASSERT(m_pCommand != NULL);
...
BOOL CAdoCommand::Append(_ParameterPtr param)
{
	...
	try
	{
		return SUCCEEDED(m_pCommand->GetParameters()->Append((IDispatch*)param));
	}
	catch (_com_error e)
	{
...
BOOL CAdoParameter::GetValue(bool &value)
{
	try
	{
		value = ConvertHelp::ConvertToBool(m_pParameter->Value);
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoParameter::GetValue(BYTE &value)
{
	try
	{
		value = ConvertHelp::ConvertToBYTE(m_pParameter->Value);
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoParameter::GetValue(short &value)
{
	try
	{
		value = ConvertHelp::ConvertToShort(m_pParameter->Value);
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoParameter::GetValue(int &value)
{
	try
	{
		value = (int)ConvertHelp::ConvertToLong(m_pParameter->Value);
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoParameter::GetValue(long &value)
{
	try
	{
		value = ConvertHelp::ConvertToLong(m_pParameter->Value);
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoParameter::GetValue(double &value)
{
	try
	{
		value = ConvertHelp::ConvertToFloat(m_pParameter->Value);
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoParameter::GetValue(CString &value)
{
	try
	{
		value = ConvertHelp::ConvertToCString(m_pParameter->Value);
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoParameter::GetValue(COleDateTime &value)
{
	try
	{
		value = ConvertHelp::ConvertToDate(m_pParameter->Value);
		return TRUE;
	}
	catch (_com_error e)
	{
